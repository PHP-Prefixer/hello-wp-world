...
namespace PPP\Symfony\Component\Translation\DependencyInjection;

use PPP\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface;
use PPP\Symfony\Component\DependencyInjection\Compiler\ServiceLocatorTagPass;
...
class TranslatorPass implements CompilerPassInterface
{
    ...
    {
        if (0 < \func_num_args()) {
            PPP_trigger_deprecation('symfony/translation', '5.3', 'Configuring "%s" is deprecated.', __CLASS__);
        }

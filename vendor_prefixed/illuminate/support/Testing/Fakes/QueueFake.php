...
use Closure;
use PPP\Illuminate\Contracts\Queue\Queue;
use PPP\Illuminate\Queue\QueueManager;
...
class QueueFake extends QueueManager implements Queue
{
    ...
    public function pushed($job, $callback = null)
    {
        ...
        return PPP_collect($this->jobs[$job])->filter(function ($data) use ($callback) {
    ...
    {
        return PPP_collect($this->jobs)->flatten(1)->filter(function ($job) use ($queue) {

...
use PPP\Carbon\Exceptions\InvalidCastException;
use PPP\Carbon\Exceptions\InvalidIntervalException;
use PPP\Carbon\Exceptions\InvalidPeriodDateException;
use PPP\Carbon\Exceptions\InvalidPeriodParameterException;
use PPP\Carbon\Exceptions\NotACarbonClassException;
use PPP\Carbon\Exceptions\NotAPeriodException;
use PPP\Carbon\Exceptions\UnknownGetterException;
use PPP\Carbon\Exceptions\UnknownMethodException;
use PPP\Carbon\Exceptions\UnreachableException;
use PPP\Carbon\Traits\IntervalRounding;
use PPP\Carbon\Traits\Mixin;
use PPP\Carbon\Traits\Options;
use Closure;
use Countable;
use DateInterval;
use DatePeriod;
...
class CarbonPeriod implements Iterator, Countable, JsonSerializable
{
     ...
     * @var string
     */
    const RECURRENCES_FILTER = 'PPP\Carbon\CarbonPeriod::filterRecurrences';
    const END_DATE_FILTER = 'PPP\Carbon\CarbonPeriod::filterEndDate';
     ...
     * @var string
     */
    const END_ITERATION = 'PPP\Carbon\CarbonPeriod::endIteration';

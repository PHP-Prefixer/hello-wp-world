...
use ArrayAccess;
use ArrayIterator;
use PPP\Illuminate\Collections\ItemNotFoundException;
use PPP\Illuminate\Collections\MultipleItemsFoundException;
use PPP\Illuminate\Support\Traits\EnumeratesValues;
        ...
        usort($items, function ($a, $b) use ($comparisons) {
            foreach ($comparisons as $comparison) {
                ...
                if (is_callable($prop)) {
                    ...
                    $values = [PPP_data_get($a, $prop), PPP_data_get($b, $prop)];

 ...
 */
namespace PPP\Carbon\Traits;

use PPP\Carbon\CarbonInterface;
use PPP\Carbon\Exceptions\InvalidTypeException;
use PPP\Carbon\Exceptions\NotLocaleAwareException;
use PPP\Carbon\Language;
use PPP\Carbon\Translator;
use Closure;
use PPP\Symfony\Component\Translation\TranslatorBagInterface;
use PPP\Symfony\Component\Translation\TranslatorInterface;
use PPP\Symfony\Contracts\Translation\LocaleAwareInterface;
use PPP\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;

if (!interface_exists('PPP\\Symfony\\Component\\Translation\\TranslatorInterface')) {
    class_alias(
        'PPP\\Symfony\\Contracts\\Translation\\TranslatorInterface',
        'PPP\\Symfony\\Component\\Translation\\TranslatorInterface'
    );
}

...
use Closure;
use Exception;
use PPP\Illuminate\Contracts\Notifications\Dispatcher as NotificationDispatcher;
use PPP\Illuminate\Contracts\Notifications\Factory as NotificationFactory;
use PPP\Illuminate\Contracts\Translation\HasLocalePreference;
use PPP\Illuminate\Support\Collection;
use PPP\Illuminate\Support\Str;
use PPP\Illuminate\Support\Traits\Macroable;
...
class NotificationFake implements NotificationDispatcher, NotificationFactory
{
    ...
    {
        $actualCount = PPP_collect($this->notifications)
            ->flatten(1)
    ...
    public function sent($notifiable, $notification, $callback = null)
    {
        ...
        $notifications = PPP_collect($this->notificationsFor($notifiable, $notification));
    ...
    public function sendNow($notifiables, $notification, array $channels = null)
    {
        ...
        foreach ($notifiables as $notifiable) {
            ...
            $this->notifications[get_class($notifiable)][$notifiable->getKey()][get_class($notification)][] = [
                ...
                'locale' => $notification->locale ?? $this->locale ?? PPP_value(function () use ($notifiable) {

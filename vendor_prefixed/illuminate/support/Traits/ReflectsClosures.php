...
use Closure;
use PPP\Illuminate\Support\Reflector;
...
trait ReflectsClosures
{
    ...
    protected function firstClosureParameterTypes(Closure $closure)
    {
        ...
        $types = PPP_collect($reflection->getParameters())->mapWithKeys(function ($parameter) {
    ...
    protected function closureParameterTypes(Closure $closure)
    {
        ...
        return PPP_collect($reflection->getParameters())->mapWithKeys(function ($parameter) {
            if ($parameter->isVariadic()) {
                return [$parameter->getName() => null];
            }

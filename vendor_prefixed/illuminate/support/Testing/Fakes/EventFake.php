...
use Closure;
use PPP\Illuminate\Contracts\Events\Dispatcher;
...
class EventFake implements Dispatcher
{
    ...
    public function dispatched($event, $callback = null)
    {
        ...
        return PPP_collect($this->events[$event])->filter(function ($arguments) use ($callback) {
    ...
    protected function shouldFakeEvent($eventName, $payload)
    {
        ...
        return PPP_collect($this->eventsToFake)

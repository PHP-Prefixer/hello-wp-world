...
use PPP\Symfony\Component\Translation\MessageSelector;
...
class LocalizationTest extends AbstractTestCase
{
    ...
    public function testGetAvailableLocales()
    {
        ...
        Carbon::setTranslator(new \PPP\Symfony\Component\Translation\Translator('en'));
    ...
    public function testTranslationCustomWithCustomTranslator()
    {
        $this->expectExceptionObject(new InvalidArgumentException(
            ...
            'PPP\Symfony\Component\Translation\IdentityTranslator has been given.'
        ));
